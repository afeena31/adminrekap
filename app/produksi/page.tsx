...
const shipmentStageColumns: ShipmentStage[] = ["menunggu-ready", "antre-pusat", "antre-packing", "sudah-dipacking", "proses-resi", "dalam-pengiriman", "ditunda", "selesai", "retur", "refund"];
